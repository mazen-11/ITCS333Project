      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a class="nav-link" href="../sgfinder/sgfinder.php">Study Group Finder</a></li>
            <li class="nav-item"><a class="nav-link" href="../CourseReview/index.php">Course Reviews</a></li>
