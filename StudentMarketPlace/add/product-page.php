    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link" href="add/add-service.html">Add product or services</a></li>
...
<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-6 mb-4">
            <img src="https://www.myprivatetutor.bh/public/frontend/images/landing_pages/small/learner_illustration_small.png?v=1689915397" id="mainImage">
        </div>

        <!-- Product Details -->
        <div class="col-md-6">
            <h2 class="mb-3">private teacher for calculas</h2>
            <p class="text-muted mb-4">Type: service</p>
            <div class="mb-3">
                <span class="h4 me-2">100$</span>
                <span class="text-muted"><s>120$</s></span>
            </div>
            <div class="mb-3">
            ...
            <p class="mb-4">Are you looking for a private calculus tutor in a specific location or online? Also, do you need help with high school, college-level, or advanced calculus? Let me know so I can find the best options for you!</p>
            ...
            <div class="mt-4">
                <h5>Key Features:</h5>
                <ul>
                    <li>Expertise & Qualifications</li>
                    <li>Personalized Teaching Approach</li>
                    <li>Clear Communication & Problem-Solving Skills</li>
                    <li>Flexibility & Availability</li>
                </ul>
            </div>
        </div>
    </div>
...
<script src="js/UseFetchedData.js"></script>
